...
import com.yolken.api.core.http.LoggingHttpClient
import com.yolken.api.core.http.PhantomReachableClosingHttpClient
import com.yolken.api.core.http.QueryParams
import com.yolken.api.core.http.RetryingHttpClient
...
private constructor(
     ...
     *
     * Use the one published in `yolken-test6-java-client-okhttp` or implement your own.
     *
     ...
     *
     * Defaults to [com.yolken.api.core.jsonMapper]. The default is usually sufficient and rarely
    ...
    class Builder internal constructor() {
        ...
        fun fromEnv() = apply {
            ...
            (System.getProperty("yolkentest6.baseUrl") ?: System.getenv("YOLKEN_TEST6_BASE_URL"))
                ?.let { baseUrl(it) }
