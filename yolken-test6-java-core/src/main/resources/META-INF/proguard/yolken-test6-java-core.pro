...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.yolken.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.yolken.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.yolken.api.** {
    <init>(...);
