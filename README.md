...
The REST API documentation can be found on [example4.com](http://example4.com). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.yolken.api/yolken-test6-java/0.2.0).
