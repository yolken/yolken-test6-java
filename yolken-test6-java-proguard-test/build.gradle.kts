...
dependencies {
    testImplementation(project(":yolken-test6-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../yolken-test6-java-core/src/main/resources/META-INF/proguard/yolken-test6-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.configure_me_yolken_test6.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../yolken-test6-java-core/src/main/resources/META-INF/proguard/yolken-test6-java-core.pro",
