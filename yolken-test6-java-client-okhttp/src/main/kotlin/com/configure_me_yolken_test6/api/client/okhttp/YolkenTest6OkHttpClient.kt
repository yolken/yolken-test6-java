...
import com.configure_me_yolken_test6.api.client.YolkenTest6ClientImpl
...
/**
 * A class that allows building an instance of [YolkenTest6Client] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class YolkenTest6OkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [YolkenTest6Client]. */
         ...
         */
        @JvmStatic fun fromEnv(): YolkenTest6Client = builder().fromEnv().build()
    }

    /** A builder for [YolkenTest6OkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [YolkenTest6Client].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): YolkenTest6Client =
            YolkenTest6ClientImpl(
                clientOptions
                    .httpClient(
