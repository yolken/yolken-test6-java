...
The REST API documentation can be found on [example18.com](http://example18.com). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.yolken.api/yolken-test6-java/0.4.0).
