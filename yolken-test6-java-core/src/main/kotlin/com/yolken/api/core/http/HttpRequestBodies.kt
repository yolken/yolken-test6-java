...
import com.yolken.api.core.MultipartField
...
private fun serializePart(name: String, node: JsonNode): Sequence<Pair<String, InputStream>> =
    when (node.nodeType) {
                    ...
                    node
                        ...
                        .mapNotNull { element ->
                            when (element.nodeType) {
                                ...
                                JsonNodeType.OBJECT,
                                JsonNodeType.POJO ->
                                    throw YolkenTest6InvalidDataException(
        ...
        JsonNodeType.POJO,
        null -> throw YolkenTest6InvalidDataException("Unexpected JsonNode type: ${node.nodeType}")
    }
