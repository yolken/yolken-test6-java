...
The REST API documentation can be found on [example2.com](http://example2.com). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.yolken.api/yolken-test6-java/0.1.0).
