...
package com.configure_me_yolken_test6.api.client.okhttp

import com.configure_me_yolken_test6.api.client.YolkenTest6ClientAsync
import com.configure_me_yolken_test6.api.client.YolkenTest6ClientAsyncImpl
import com.configure_me_yolken_test6.api.core.ClientOptions
import com.configure_me_yolken_test6.api.core.Sleeper
import com.configure_me_yolken_test6.api.core.Timeout
import com.configure_me_yolken_test6.api.core.http.Headers
import com.configure_me_yolken_test6.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [YolkenTest6ClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class YolkenTest6OkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [YolkenTest6ClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): YolkenTest6ClientAsync = builder().fromEnv().build()
    }

    /** A builder for [YolkenTest6OkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.configure_me_yolken_test6.api.core.jsonMapper]. The default is usually
        ...
        /**
         * Returns an immutable instance of [YolkenTest6ClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): YolkenTest6ClientAsync =
            YolkenTest6ClientAsyncImpl(
                clientOptions
                    .httpClient(
