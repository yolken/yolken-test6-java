...
The Yolken Test6 Java SDK provides convenient access to the [Yolken Test6 REST API](http://example14.com) from applications written in Java.
...
The REST API documentation can be found on [example14.com](http://example14.com). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.yolken.api/yolken-test6-java/0.4.0).
